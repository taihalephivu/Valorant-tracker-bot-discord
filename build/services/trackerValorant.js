...
exports.TrackerValorantService = void 0;
const axiosClient_1 = require("./axiosClient");
class TrackerValorantService {
    axiosInstance;
    constructor(apiKey) {
        this.axiosInstance = (0, axiosClient_1.getAxiosInstance)(apiKey);
    }
    async getPlayerProfile(gameName, tag, region) {
        try {
    ...
    async getLiveMatch(gameName, tag, region) {
        try {
            const regionCode = region || 'ap';
    ...
    async getMMRHistory(gameName, tag, region, size = 10) {
        try {
            const regionCode = region || 'ap';
...
exports.TrackerValorantService = TrackerValorantService;
