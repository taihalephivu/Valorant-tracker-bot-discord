...
exports.createProfileEmbed = createProfileEmbed;
const discord_js_1 = require("discord.js");
function createProfileEmbed(options) {
    ...
    const agentSegments = profile.segments.filter((s) => s.type === 'agent');
    let topAgents = '';
    ...
    const embed = new discord_js_1.EmbedBuilder()
        ...
        .addFields({ name: '🏆 Rank', value: rankDisplay, inline: true }, { name: '⚔️ K/D Ratio', value: kdRatio, inline: true }, { name: '🎯 Headshot %', value: headshots, inline: true }, { name: '✅ Wins', value: wins, inline: true }, { name: '❌ Losses', value: losses, inline: true }, { name: '📈 Win Rate', value: winRate, inline: true }, { name: '💀 Kills', value: kills, inline: true }, { name: '☠️ Deaths', value: deaths, inline: true }, { name: '🤝 Assists', value: assists, inline: true }, { name: '⏱️ Time Played', value: timePlayed, inline: true }, { name: '💯 Score/Match', value: score, inline: true }, { name: '💥 Damage/Round', value: damage, inline: true })
